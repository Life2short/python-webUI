...
CHROMEDRIVER_PATH = cc.DRIVER_PATH + '\chromedriver.exe'
IEDRIVER_PATH = cc.DRIVER_PATH + '\IEDriverServer.exe'
PHANTOMJSDRIVER_PATH = cc.DRIVER_PATH + '\phantomjs.exe'
...
class Browser(object):
    ...
    def get(self, url, maximize_window=True, implicitly_wait=30):
        os.environ["webdriver.chrome.driver"] = EXECUTABLE_PATH[self._type]
